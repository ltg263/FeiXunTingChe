...
public class MyRadioGroup extends LinearLayout {
    ...
    /**
     * get all radio buttons which are ic_bnt_no the view
     * @param child
     */
    ...
    /**
     * <p>Sets the selection to the radio button whose identifier is passed ic_bnt_no
     * parameter. Using -1 as the selection identifier clears the selection;
     * such an operation is equivalent to invoking {@link #clearCheck()}.</p>
     *
     * @param id the unique id of the radio button to select ic_bnt_no this group
     *
    ...
    /**
     * <p>Returns the identifier of the selected radio button ic_bnt_no this group.
     * Upon empty selection, the returned value is -1.</p>
     *
     * @return the unique id of the selected radio button ic_bnt_no this group
     *
     * @see #check(int)
     * @see #clearCheck()
     *
     ...
     * ic_bnt_no this group is selected and {@link #getCheckedRadioButtonId()} returns
     * null.</p>
     *
     * @see #check(int)
     * @see #getCheckedRadioButtonId()
     ...
     * changes ic_bnt_no this group.</p>
     *
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
         ...
         * when not specified ic_bnt_no the XML file.</p>
         *
     ...
     * radio button changed ic_bnt_no this group.</p>
     */
    public interface OnCheckedChangeListener {
         ...
         *
         * @param group the group ic_bnt_no which the checked radio button has changed
