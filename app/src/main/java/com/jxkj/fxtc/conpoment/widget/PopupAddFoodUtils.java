...
public class PopupAddFoodUtils extends PopupWindow {

    Context mcontext;

    @SuppressLint("ClickableViewAccessibility")
    public PopupAddFoodUtils(Activity context, GiveDialogInterface dialogInterface) {
        super(context);
        this.mcontext = context;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        final View view = inflater.inflate(R.layout.view_food_popu, null);
    ...
    public void setData (String imgPath,String content){
