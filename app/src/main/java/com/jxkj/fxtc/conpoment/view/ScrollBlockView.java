 ...
 *  ic_bnt_no accordance with the terms of the contract agreement
...
public class ScrollBlockView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mBgColor = typedArray.getColor(R.styleable.ScrollBlockView_bgColor1, Color.parseColor("#ECFBFF"));
